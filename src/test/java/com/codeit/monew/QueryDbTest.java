...
public class QueryDbTest {
    ...
    public void queryDb() throws Exception {
        ...
        try (Connection conn = DriverManager.getConnection(url, user, password);
            ...
            ResultSet rs = stmt.executeQuery("SELECT count(*) FROM interest;");
            rs.next();
            ...
            java.nio.file.Files.write(java.nio.file.Paths.get("db_state.txt"), 
                ("DB State -> Interests: " + interests + ", Articles: " + articles).getBytes());
        }
    }
}
